...
class TestSnapshot:
    ...
    def test_snapshot_creation(self):
        ...
        snapshot = Snapshot(snapshot_name="test_snapshot", project_name="test_project")
    ...
    def test_is_ready_when_no_worker(self):
        ...
        snapshot = Snapshot(snapshot_name="test", project_name="test_project", worker_pid=None)
    ...
    def test_is_not_ready_when_worker_active(self):
        ...
        snapshot = Snapshot(snapshot_name="test", project_name="test_project", worker_pid=12345)
...
class TestDatabaseTable:
    ...
    def test_table_creation(self):
        ...
        table = DatabaseTable(table_name="test_db", snapshot=snapshot)
    ...
    def test_get_internal_name_master(self):
        ...
        snapshot = Snapshot(snapshot_name="test", project_name="test_project", hash="abc123def456")

        table = DatabaseTable(table_name="mydb", snapshot=snapshot)
    ...
    def test_table_repr(self):
        ...
        snapshot = Snapshot(snapshot_name="test", project_name="test_project")

        table = DatabaseTable(id=1, table_name="test_db", snapshot=snapshot)
    ...
    def test_size_bytes_optional(self):
        ...
        table = DatabaseTable(table_name="test_db", snapshot=snapshot, size_bytes=1024000)
